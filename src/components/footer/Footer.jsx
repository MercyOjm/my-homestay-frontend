...
const Footer = () => {
  return (
    <div
      className="container-fluid bg-footer  py-5 px-sm-3 px-lg-5"
    ...
    >
      <div className="row pt-5">
        <div className="col-lg-3 col-md-6 mb-5">
          ...
          <h6
            className="text-black text-uppercase mt-4 mb-3"
            style={{ lineSpacing: 5 + "px" }}
          >
            Follow Us
          </h6>
        ...
        <div className="col-lg-3 col-md-6 mb-5">
          <h5
            className="text-black text-uppercase mb-4"
            style={{ lineSpacing: 5 + "px" }}
          >
            Our Services
          </h5>
